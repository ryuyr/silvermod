...
@OnlyIn(Dist.CLIENT)
public class PlaceholderSwordImageShooterRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(PlaceholderSwordImageShooterItem.arrow,
					renderManager -> new CustomRender(renderManager));
		}
	}

	@OnlyIn(Dist.CLIENT)
	public static class CustomRender extends EntityRenderer<PlaceholderSwordImageShooterItem.ArrowCustomEntity> {
		...
		@Override
		public void render(PlaceholderSwordImageShooterItem.ArrowCustomEntity entityIn, float entityYaw, float partialTicks,
		...
		@Override
		public ResourceLocation getEntityTexture(PlaceholderSwordImageShooterItem.ArrowCustomEntity entity) {
			return texture;
		}
	}
